...
# ==================== KONFIGURASI ====================
API_KEY    = "1xmMPK7d5sFyJ1ea9U"
API_SECRET = "vCeI2dZhhdFGvLvi7OoYNg9IlAHkPT9T3Wca"
...
ENTRY_MARGIN  = 15.0         # margin dasar (USDT) — DOSIS MINI 11 Agu (saldo $5)
...
RISK_HARD_USD = 6.00        # plafon rugi absolut per trade
MARGIN_MAX_PCT = 35.0       # plafon margin per posisi: maks 25% saldo
